...
| `GONIC_LDAP_PORT`                      | `-ldap-port`                      | **optional** what port the LDAP server is hosted on (*default* `389`)                                                                                                                                                                      |
| `GONIC_LDAP_TLS`                      | `-ldap-tls`                      | **optional** whether gonic will connect to the LDAP server using TLS (*default* `false`)                                                                                                                                                                      |
...
| `GONIC_LDAP_ADMIN_FILTER`                      | `-ldap-admin-filter`                      | **optional** the filter to select LDAP admin objects with (escaping the commas might be necessary if using environmental variable) (*default* `(memberof=cn=admin)`)                                                                                                                                                                      |
